...
class MP2Base(EngBase):
    ...
    def __init__(self, mf, frozen=None, omega=0, with_df=None, c_os=1.0, c_ss=1.0, **kwargs):
        super().__init__(mf)
        self.omega = omega
        self.c_os = c_os
        self.c_ss = c_ss
...
class RMP2ConvPySCF(mp.mp2.RMP2, EngBase):
    ...
    def __init__(self, mf, c_os=1.0, c_ss=1.0, *args, **kwargs):
    ...
    def driver_eng_mp2(self, *args, **kwargs):
        ...
        self.results["eng_corr_MP2"] = self.c_os * self.e_corr_os + self.c_ss * self.e_corr_ss
...
def kernel_energy_rmp2_conv_full_incore(
        mo_energy, mo_coeff, eri_or_mol, mo_occ, c_os, c_ss,
